                ...
                <div class="accordion-header" id="heading${order.id}">
                    <div class="row align-items-center">
                        ...
                        <div class="col-md p-3">
                            <fmt:message key="order.price"/> ${money}${order.totalPrice}
                        </div>
                        <div class="col-md p-3">
                            <fmt:message key="order.sale"/> ${order.giftCard}
                        </div>
                        <div class="col-md p-3">
                            <fmt:message key="order.total_price"/> ${money}${order.totalPrice}
                        </div>
                        <div class="col-md-1 p-3">
                            <button class="accordion-button collapsed bg-light" type="button" data-toggle="collapse" data-target="#collapse${order.id}" aria-expanded="true" aria-controls="collapse${order.id}">
                            </button>
                        </div>
                    </div>
                </div>
                <div id="collapse${order.id}" class="accordion-collapse collapse" aria-labelledby="heading${order.id}" data-parent="#orderHistory">
                    <hr>
                    <div class="mx-5">
                    ...
                    <c:forEach items="${order.components}" var="component">
                        <div class="row m-3 align-items-start">
                            ...
                            <div class="col-md-2 text-center">
                                <a href="${absolutePath}/controller?command=open_item_page&id=${component.item.id}" class="link">
