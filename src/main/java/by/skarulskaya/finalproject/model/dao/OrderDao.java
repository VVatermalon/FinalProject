...
public abstract class OrderDao extends AbstractDao<Integer, Order> {
    public abstract boolean createCartOrder(int customerId, Order order) throws DaoException;
    ...
    public abstract boolean registerOrder(Order order) throws DaoException;
}
