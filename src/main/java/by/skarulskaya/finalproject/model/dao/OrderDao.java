...
public abstract class OrderDao extends AbstractDao<Integer, Order> {
    ...
    public abstract List<Order> findAllByStatusByPage(Order.OrderStatus status, int count, int offset) throws DaoException;

    public abstract List<Order> findAllByDateByPage(LocalDate date, int count, int offset) throws DaoException;

    public abstract List<Order> findAllByStatusByDateByPage(Order.OrderStatus status, LocalDate date, int count, int offset) throws DaoException;
